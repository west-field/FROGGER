...
namespace my
{
	...
	/// グラフィックの描画
	/// </summary>
	/// <param name="x">左座標x</param>
	/// <param name="y">上座標y</param>
	/// <param name="handle">画像のハンドル</param>
	...
	/// <param name="y">描画中心座標y</param>
	/// <param name="left">描画したい画像の左座標</param>
	/// <param name="top">描画したい画像の上座標</param>
	/// <param name="width">描画するグラフィックのサイズW</param>
	/// <param name="height">描画するグラフィックのサイズH</param>
